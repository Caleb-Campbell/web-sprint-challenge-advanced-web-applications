...
export default function ArticleForm(props) {
  ...
  useEffect(() => {
    ...
    // setValues(initialFormValues || currentArticle)
  ...
  return (
    ...
    <form id="form" onSubmit={onSubmit}>
      ...
      <input
        maxLength={50} onChange={onChange} value={values.title} placeholder="Enter title" id="title"
      />
      <textarea
        maxLength={200} onChange={onChange} value={values.text} placeholder="Enter text" id="text"
      />
